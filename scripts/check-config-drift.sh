#!/bin/sh
# scripts/check-config-drift.sh — 检查四平台生成目录是否与 vocabcraft.plugin 真相源一致
#
...
# skills/**：以 vocabcraft.plugin/skills 为权威，检查四平台副本存在且一致
...
echo "config-drift: 四平台配置与 vocabcraft.plugin 真相源一致"
exit 0